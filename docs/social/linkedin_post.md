...
- Explainable 3 to 6 month revenue forecast
...
- `assets/demo/demo.mp4` or `assets/demo/demo.webm`
...
#Python #Streamlit #DataAnalytics #BusinessIntelligence #SQLite #Plotly #PortfolioProject #InternshipReady
